...
def main():
    ...
    require(injected.get("lora", "").startswith("flux2klein/"), "injected LoRA must be flux2klein-prefixed")
    require("flux1dev" not in injected.get("lora", ""), "incompatible flux1dev LoRA was not filtered")
